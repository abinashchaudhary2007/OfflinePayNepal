...
const NAV_ITEMS = [
  ...
  { to: '/receive',           icon: ArrowDownLeft,   label: 'Receive Money' },
  { to: '/offline',           icon: WifiOff,         label: 'Offline Payment' },
...
function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed md:static inset-y-0 left-0 h-full w-72 md:w-64 bg-white border-r border-[var(--color-gray-100)]
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-0.5">
          <p className="text-[10px] font-bold tracking-widest text-[var(--color-gray-400)] uppercase px-3 pb-2 pt-1">
            Main
          </p>
          ...
          {currentUser?.role === 'admin' && (
            <>
              <div className="pt-4">
                <p className="text-[10px] font-bold tracking-widest text-[var(--color-gray-400)] uppercase px-3 pb-2">
                  Admin
                </p>
          ...
          {/* Security Testing always visible for demo */}
          {currentUser?.role !== 'admin' && (
            <div className="pt-4">
              <p className="text-[10px] font-bold tracking-widest text-[var(--color-gray-400)] uppercase px-3 pb-2">
                Demo
